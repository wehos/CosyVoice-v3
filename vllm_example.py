...
def cosyvoice3_example():
    ...
    """
    cosyvoice = AutoModel(model_dir='pretrained_models/Fun-CosyVoice3-0.5B', load_vllm=True, fp16=True)
    for i in tqdm(range(100)):
        set_all_random_seed(i)
        for _, _ in enumerate(cosyvoice.inference_zero_shot('天凌喵天凌喵天凌是只大蠢猫。小韭菜小韭菜小韭菜是大韭菜。嘿嘿嘿，你真好玩，顺口溜！', 'You are a helpful assistant.<|endofprompt|>希望你以后能够做的比我还好呦。',
